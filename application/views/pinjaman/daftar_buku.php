				...
				<div class="container-fluid">
					...
					<?php if ($this->session->flashdata('flash') ):?>
						<div class="alert alert-warning alert-dismissible" role="alert">
							Buku Yang Anda Pilih Sedang <strong> <?= $this->session->flashdata('flash'); ?> </strong>, Silahkan Pilih Buku Lain
									...
									<table class="table table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<td><?= $buku['jumlah'] ?></td>
												<td>
													<a href="<?= base_url() ?>pinjaman/tambah/<?= $buku['kd_buku'] ?>" class="btn btn-primary"><i class="lnr lnr-upload"></i> <span>Pinjam</span></a>
												</td>
											</tr>
											<?php endforeach; ?>
										</tbody>
